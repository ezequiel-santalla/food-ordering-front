...
import { CommonModule } from '@angular/common'; // Importar CommonModule para @if
import {
  LucideAngularModule,
  Bell,
  User,
...
import { AuthStateManager } from '../../../auth/services/auth-state-manager.service'; // Ajusta la ruta
...
export class Header {
  ...
  private router = inject(Router); // --- Íconos ---
  ...
  readonly LogIn = LogIn; // --- Estado de Autenticación ---

  isAuthenticated = this.authState.isAuthenticated;
  isGuest = this.authState.isGuest;
  hasActiveSession = this.tableSessionService.hasActiveSession; // --- Datos de Sesión ---
